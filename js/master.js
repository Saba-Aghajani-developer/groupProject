 ...
 // part1 
  ...
  document.addEventListener("scroll", () => {
    ...
    if (wsn > wso) {
      ...
      mfig1.style.transform = "translateX("+ (wsn/20)+"px)";
      mfig2.style.transform = "translateX("+ -(wsn/12)+"px)";
      mfig3.style.transform = "translateX("+ -(wsn/60)+"px)";
      ...
      mdiv3.style.transform = 'rotate(10deg) translate3d(-800px, 0px, 0px)'
      mfig1.style.transform = "translateX("+ -(wsn/20)+"px)";
      mfig2.style.transform = "translateX("+ (wsn/36)+"px)";
      mfig3.style.transform = "translateX("+ (wsn/20)+"px)";
